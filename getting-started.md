...
- [ ] you can navigate the links between your notes by `cmd+click` (or `ctrl+click` on Windows) on a wiki link. You can go back with `ctrl+-`. Here, go to your [[01_inbox/inbox]]
...
- [ ] Want to see how to manage your tasks? Go to the [[Notes/Irl/todo]] note
