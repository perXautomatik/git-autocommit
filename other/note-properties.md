...
- the `title` property will assign the name to the note that you will see in the graph, regardless of the filename or the first heading (also see how to [[Notes/docs/how-to/write-notes-in-foam]])
